 ...
 $.fn.extend({
 	...
 	customStyle : function(options) {
	  ...
	  return this.each(function() {
	  		    if ($(this).next().hasClass('customSelectBox')){return;};
			    var currentSelected = $(this).find(':selected');
			    $(this).after('<span class="customSelectBox"><span class="customSelectBoxInner">'+currentSelected.text()+'</span></span>').css({position:'absolute', opacity:0,fontSize:$(this).next().css('font-size')});
			    ...
			    selectBoxSpan.mouseenter(function(){
			        var selectBoxSpan = $(this);
			        var selectBoxSpanInner = selectBoxSpan.find(':first-child');
			        var selectBoxHeight = parseInt(selectBoxSpan.height()) + parseInt(selectBoxSpan.css('padding-top')) + parseInt(selectBoxSpan.css('padding-bottom'));
			        //if (selectBoxHeight<25){selectBoxHeight=25;};
			        ...
			        $(this).prev().width(selectBoxWidth);
			        $(this).prev().height(selectBoxHeight);
    			});
	    });
	  }
	}
...
$.fn.height = function (e,f) {
    if (this.is($(window))) {
        if (typeof e == 'undefined'&&typeof f == 'undefined'){
            ...
            return this.oldHeightFunction(e,f);
        }
    } else {
        if (typeof e == 'undefined'&&typeof f == 'undefined'){
